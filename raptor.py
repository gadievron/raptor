...
def print_raptor_banner():
    """Print ASCII raptor banner."""
    banner = r"""
    ╔═══════════════════════════════════════════════════════════════════════════╗
    ║                                                                           ║
    ║                  RAPTOR - Security Testing Framework                     ║
    ║         Recursive Autonomous Penetration Testing & Observation Robot     ║
    ║                                                                           ║
    ║                            By Gadi & Daniel                               ║
    ║                                  v2.0                                     ║
    ║                                                                           ║
    ╚═══════════════════════════════════════════════════════════════════════════╝
            ...
            "Autonomous security testing, evolved."
    """
    print(banner)
