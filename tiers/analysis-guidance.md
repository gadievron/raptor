# Post-Scan Analysis Guidance
# Auto-loads: After scan completes (keywords: "findings", "results", "vulnerabilities")
...
failed) enough exploits to know what actually works.
