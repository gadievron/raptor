---
name: "source-command-oss-forensics"
description: "Evidence-backed forensic investigation for GitHub repositories"
---

# source-command-oss-forensics

Use this skill when the user asks to run the migrated source command `oss-forensics`.
...
1. **Read the orchestration skill:**
   `.agents/skills/oss-forensics/orchestration/SKILL.md`
...
- **GOOGLE_APPLICATION_CREDENTIALS**: BigQuery credentials for GH Archive queries
  - See `.agents/skills/oss-forensics/github-archive/SKILL.md` for setup
...
- You (main Codex) are the orchestrator - you spawn all agents
