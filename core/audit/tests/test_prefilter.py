...
def test_simple_accessor_skipped():
    source = """\
...
def test_simple_accessor_with_array_not_skipped():
    source = """\
...
def test_uint16_offset_detected():
    source = """\
...
def test_python_path_traversal_detected():
    source = """\
...
def test_python_simple_return_skipped():
    source = """\
def get_name(self):
    return self.name
"""
...
def test_mechanical_evidence_formatted():
    source = """\
void f(const char *s) {
    char buf[32];
    strcpy(buf, s);
...
def test_dangerous_callees_prevent_skip():
    source = """\
void f(void) {
    return;
}"""
...
def test_pointer_ops_prevent_skip():
    source = """\
int f(int *p) {
    return *(p + 1);
}"""
...
def test_array_index_no_bounds_check():
    source = """\
...
def test_array_index_with_bounds_check_no_hit():
    source = """\
...
def test_no_uaf_after_reassign():
    source = """\
...
def test_post_loop_oob_detected():
    source = """\
...
def test_post_loop_oob_safe_cap_minus_one():
    source = """\
...
def test_post_loop_oob_safe_guarded():
    source = """\
...
def test_post_loop_oob_braceless_loop_no_fp():
    source = """\
...
def test_malloc_multiply_overflow():
    source = """\
...
def test_sink_unreachable_small_fn_skipped():
    source = """\
...
def test_sink_unreachable_large_fn_not_skipped():
...
def test_sink_unreachable_auth_keyword_not_skipped():
    source = """\
...
def test_sink_unreachable_crypto_not_skipped():
    source = """\
...
def test_sink_unreachable_mutex_not_skipped():
    source = """\
...
def test_sink_unreachable_false_still_reviews():
    source = """\
...
def test_sink_unreachable_with_hits_not_skipped():
    source = """\
void parse(char *buf) {
    strcpy(dst, buf);
}"""
