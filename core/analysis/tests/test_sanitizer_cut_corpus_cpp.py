...
def test_resolver_returns_cppcfg_for_c_file(tmp_path):
    ...
    from core.analysis.cfg_builder_cpp import CPPCFG
...
def test_resolver_failure_when_no_enclosing_function(tmp_path):
    ...
    from core.analysis.finding_resolver import ResolutionFailure
    src = tmp_path / "junk.c"
...
def test_callgraph_only_still_candidate_only():
    ...
    binding" carve-out."""
    from core.analysis.cfg_builder import CallGraphNode
