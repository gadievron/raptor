"""Tests for :mod:`core.analysis.reachability`.
...
def test_python_no_path_from_entry_witness_stays_heuristic():
    ...
    from core.analysis.reach_witness import VERDICTS, Soundness
...
def test_unknown_language_profile_has_no_entry_signal():
    ...
    from core.analysis.reachability import _profile
    p = _profile("kotlin")
...
def test_annotation_tail_strips_fqn_args_and_at():
    from core.analysis.reachability import _annotation_tail
...
def test_java_servlet_and_method_dispatch_are_entries():
    from core.analysis.reachability import _java_framework_entry
...
def test_ts_method_dispatch_decorators_are_entries():
    from core.analysis.reachability import _ts_framework_entry
...
def test_csharp_method_route_attrs_are_entries():
    from core.analysis.reachability import _csharp_framework_entry
...
def test_ruby_framework_base_promotes_class_methods():
    from core.analysis.reachability import _ruby_framework_entry
...
def test_php_method_route_attr_is_entry():
    from core.analysis.reachability import _php_framework_entry
