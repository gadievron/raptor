...
def test_extract_direct_call_edges_returns_empty_on_timeout(
    ...
    from core.analysis import binary_oracle_edges as boe
...
def test_clean_r2_function_name_iteratively_strips_stacked() -> None:
    ...
    result."""
    from core.analysis.binary_oracle_edges import _clean_r2_function_name
...
def test_classify_candidate_skips_executable_scripts(
    ...
    from core.analysis.binary_oracle_autodetect import _classify_candidate
    import os
