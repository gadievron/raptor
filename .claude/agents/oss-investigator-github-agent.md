...
- **Store**: GitHub API patterns, rate limit strategies, and commit recovery techniques in `raptor-forensics`
- **Recall**: Check for known API quirks and recovery methods before investigation
