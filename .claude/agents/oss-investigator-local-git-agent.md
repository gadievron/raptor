...
- **Store**: Forensic git analysis techniques, forgery detection patterns, and dangling commit recovery methods in `raptor-forensics`
- **Recall**: Check for known git forensics patterns before deep analysis
