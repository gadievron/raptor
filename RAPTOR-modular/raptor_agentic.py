...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Full autonomous workflow (Semgrep + CodeQL)
  python3 raptor_agentic.py --repo /path/to/code --codeql

  # Semgrep only (default)
  python3 raptor_agentic.py --repo /path/to/code --policy-groups crypto,secrets
  ...
  python3 raptor_agentic.py --repo /path/to/code --codeql --max-findings 20

  # Skip exploit generation (analysis + patches only)
  python3 raptor_agentic.py --repo /path/to/code --codeql --no-exploits
        """
    )
